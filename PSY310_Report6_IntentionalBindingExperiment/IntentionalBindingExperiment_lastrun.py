...
expName = 'IntentionalBindingExperiment'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\dhani\\OneDrive\\Desktop\\PSY310_Report6_IntentionalBindingExperiment\\IntentionalBindingExperiment_lastrun.py',
